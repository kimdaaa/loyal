...
class Stats:
    ...
    def save_data(self, data):
        try:
            os.mkdir(os.path.join(os.getenv('APPDATA'), "rankchecker"))
        except FileExistsError:
            pass
        try:
            with open(os.path.join(os.getenv('APPDATA'), "rankchecker/stats.json"), "r") as f:
        ...
        with open(os.path.join(os.getenv('APPDATA'), "rankchecker/stats.json"), "w") as f:
